...
export const FETCH_CLIENTS_FROM_EDITION_INIT =
  "@billing/FETCH_CLIENTS_FROM_EDITION_INIT";
export const FETCH_CLIENTS_FROM_EDITION_SUCCESS =
  "@billing/FETCH_CLIENTS_FROM_EDITION_SUCCESS";
export const FETCH_CLIENTS_FROM_EDITION_FAILURE =
  "@billing/FETCH_CLIENTS_FROM_EDITION_FAILURE";
