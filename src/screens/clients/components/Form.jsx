    ...
    <Formik
      ...
      validate={values => {
        ...
        const schema = Yup.object().shape({
          ...
          taxCategoryId: Yup.mixed().when(
            ["countryId", "isComtur", "billingPointOfSale"],
            {
              is: (countryId, isComtur, billingPointOfSale) => {
                return (
                  (countryId == "4" && isComtur === false) ||
                  (isComtur === true && billingPointOfSale === "99")
                );
              },
